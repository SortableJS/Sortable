...
function dispatchEvent({
  ...
  let allEventProperties = _objectSpread({}, extraEventProperties, {}, PluginManager.getEventProperties(name, sortable));
...
let pluginEvent = function (eventName, sortable, _ref = {}) {
  let {
    evt: originalEvent
  } = _ref,
